...
*/
public class ParseAnterior {


  public static void parseAnoAnterior(Mongo mongoClient,DB db,final DBCollection coll)throws Exception {
    parseFiles(mongoClient,db,coll,"AnoAnterior","2014");
  }
  ...
  public static void main(String[] args) throws Exception {
    ...
    parseAnoAnterior(mongoClient,db,coll);
